...
public class UserControllerTest {
	...
	{
		testUser = new User();
		testUser.setEmployeeId("248121");
		testUser.setFirstName("Raj");
		testUser.setLastName("Mohan");
	...
	public void addUser() throws Exception {
		...
		String restURI = "/pmapp/userAction/addUser";
	...
	public void getUser() throws Exception {
		String expectedJson = createJson(testUser);
		String restURI = "/pmapp/userAction/getUserById/" + Long.toString(testUser.getUserId());
	...
	public void updateUser() throws Exception {
		...
		String expectedJson = createJson(testUser);
		String restURI = "/pmapp/userAction/updateUser";
        String outJson = returnExpectedJson(expectedJson,restURI);
        User retUser = createObject(outJson);
        assertEquals(retUser.getEmployeeId(), testUser.getEmployeeId());
	}
	...
	public void deleteUser() throws Exception {
		String expectedJson = createJson(testUser);
		String restURI = "/pmapp/userAction/deleteUser";
        String outJson = returnExpectedJson(expectedJson,restURI);
        User retUser = createObject(outJson);
        assertEquals(retUser.getEmployeeId(), testUser.getEmployeeId());
	}

...
public class ProjectControllerTest {
	...
	public void addProject() throws Exception {
		...
		String restURI = "/pmapp/projectAction/addProject";
	...
	public void getProject() throws Exception {
		String expectedJson = createJson(project);
		String restURI = "/pmapp/projectAction/getProjectById/" + Long.toString(project.getProjectId());
        String outJson = returnExpectedJson(expectedJson,restURI);
        Project retProject = createObject(outJson);
        assertEquals(retProject.getPriority(), project.getPriority());
	}
	...
	public void updateProject() throws Exception {
		String expectedJson = createJson(project);
		String restURI = "/pmapp/projectAction/updateProject";
        String outJson = returnExpectedJson(expectedJson,restURI);
        Project retProject = createObject(outJson);
        assertEquals(retProject.getPriority(), project.getPriority());
	}
	...
	public void deleteProject() throws Exception {
		...
		String expectedJson = createJson(project);
		String restURI = "/pmapp/projectAction/deleteProject";
        String outJson = returnExpectedJson(expectedJson,restURI);
        Project retProject = createObject(outJson);
        assertEquals(retProject.getPriority(), project.getPriority());
	}
	...
	private String returnExpectedJson(String expectedJson, String restURI) throws Exception
	{
		...
		Mockito.when(projectService.addProject(Mockito.any(ProjectModel.class))).thenReturn(project);
		Mockito.when(projectService.deleteProject((Mockito.any(ProjectModel.class)))).thenReturn(project);
